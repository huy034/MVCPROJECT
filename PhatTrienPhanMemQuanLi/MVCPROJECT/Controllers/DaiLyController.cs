...
namespace MVCPROJECT.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,MaHTPP,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaiLy,MaHTPP,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai")] DaiLy daiLy)
        {
            if (id != daiLy.MaDaiLy)
            {
                return NotFound();
